...
class HiloContador extends Thread {
    ...
    private ContadorEj5 applet; // Referencia al applet para llamar a repaint()

    public HiloContador(long contadorInicial, ContadorEj5 applet) {
...
public class ContadorEj5 extends Applet implements ActionListener {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Contador 2: " + (hilo2 != null ? hilo2.getContador() : 50), 50, 150);
    }
}
